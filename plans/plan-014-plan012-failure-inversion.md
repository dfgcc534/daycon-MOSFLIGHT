...
| c2.1 | docs | **v2.1 simplification — §2.2 Out-of-scope negative blacklist 통합.** plan-004/006/012 module·weight 재사용 7 row → 1 row (positive "from-scratch 새 module" 한 줄). §1.5 마지막 bullet 의 redundant negative phrasing 정리. 보존 = §2.1 positive spec (anchor 0.01m / Gaussian soft) / §3.3 The Config / §3.4 G1 import check (measurable G-gate) / 7-mode 표 / §1.2~§1.3 trap chain (historical reference). frontmatter version 2→2.1 | [TODO] |
