"""
PB_0.6822 BOUNDARY — Tiny Correction MLP (Residual Boundary Corrector)

Extracted from notes/PB_0.6822 코드공유.ipynb cell 6 (plan-004 c3).

ONLY modification: import alias changed for src/* module path.
    OLD: import train_tcn_gru_candidate_selector as base
    NEW: from src.pb_0_6822 import selector as base

Exports:
    BOUNDARY_MAIN: callable                     # argparse entry point (= main)
    TinyCorrectionNet: nn.Module
    ResidualMLPBlock: nn.Module
    local_frame, vector_to_local, local_to_vector, cap_vectors
    make_rows, build_pretrain, train_net,
    predict_delta, evaluate, predict_corrected_candidates
"""
# ruff: noqa
# fmt: off
